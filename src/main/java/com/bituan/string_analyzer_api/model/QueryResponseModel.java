...
public class QueryResponseModel {
    private List<StringPropertiesModel> data;
    private int count;
    private Map<String, ?> filters_applied;

    public QueryResponseModel() {}

    public QueryResponseModel(List<StringPropertiesModel> data, int count, Map<String, ?> filters_applied) {
        this.data = data;
        this.count = count;
        this.filters_applied = filters_applied;
    }

    public List<StringPropertiesModel> getData() {
        return data;
    }

    public void setData(List<StringPropertiesModel> data) {
        this.data = data;
    }
